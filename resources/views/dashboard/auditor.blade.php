    ...
    <div class="container-fluid">
                        ...
                        <div class="card bg-dark text-white mb-4" style="height: 11rem">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                ...
                                <div class="text-white" style="font-size: 20px">
                                    <p>$ {{number_format(App\Models\SoportePago::sum('total') ,2,",",".")}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card bg-info text-white mb-4" style="height: 11rem">
                    <div class="card-body">Servicios Facturados En Soportes (Todos)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <div class="text-white" style="font-size: 25px">
                        <p>{{ App\Models\SoportePago::sum('cantidad') }}</p>
                    </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white mb-4" style="height: 11rem">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-white" style="font-size: 25px">
                            <p>$ {{number_format(App\Models\SoportePago::whereBetween('fechaInicio',[
                                    date("Y-m-d", strtotime($sistema->fechaEvaluada)),
                                    date("Y-m-d", strtotime($sistema->fechaLimite()))])->sum('total')
                                     ,2,",",".")}}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white mb-4" style="height: 11rem">
                    <div class="card-body">Servicios Facturados En Boletas (Periodo Actual)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="text-white" style="font-size: 50px">
                            <i class="fas fa-file-invoice-dollar"></i>
                        </div>
                        <a class="small text-white stretched-link"
                            style="font-size: 25px">{{ App\Models\Boleta::whereBetween('fechaInicio',[
                                date("Y-m-d", strtotime($sistema->fechaEvaluada)),
                                date("Y-m-d", strtotime($sistema->fechaLimite()))])->sum('cantidad') }}</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                Servicios Pendientes Por Generar Boleta De Relación De Servicios
            </div>
