                ...
                <div class="form-panel">
                    ...
                    <div class="form-horizontal style-form">
                        <div class="form-group">
                            <h3 style= "margin-left:3%; margin-right:3%" >Con la asignación del nuevo cargo <strong>{{ $accesos['nomCargo'] }}</strong> 
                                este usuario debera tener los siguientes sistemas complementarios: 
                            <br><br>
                    ...
                    <input type="hidden"  name="cedula" id="cedula" value= "{{ $docum['CEDUSU']}}">
                    <input type="hidden"  name="bandera1" id="bandera1" value= "1">
                    <h3 style="color:aqua"><strong>Gestion Documental</strong></h3><br> 
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 @if($errors->has('ROLUSU'))
                            ...
                            @endif
                            <select class="form-control" name="ROLUSU" id="ROLUSU">
